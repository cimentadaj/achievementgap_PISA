...
<<graph_complete_tracking_graph, include = T, fig.width = 9.5, out.height = '7in', out.width = '6.5in', fig.align = 'center', fig.cap = 'Simulation: predicted 90/10 achievement gap for different tracking setups'>>=
new_data <-
  ready_data_age %>%
...
% \begin{figure}[!htbp]
% \begin{center}
<<interaction_plot, include = T, out.height = '5in', out.width = '5.5in', fig.align = 'center', fig.cap = 'Interaction between tracking and vocational values. Legend ordered relative to the lines'>>=
plot_interaction <-
...
<<graph_all_gaps, include = T, out.height = '5in', out.width = '5.5in', fig.align = 'center', fig.cap = 'Evolution of the achievement gap for several gaps'>>=
complete_gaps %>%
  mutate(country = factor(country, levels = ordered_cnt, ordered = TRUE)) %>%
  filter(type_test == "math",
