...
ready_data_age <- mutate(ready_data, age_selection = ifelse(selage >= 15, 1, 0))
...
pp_check(mod_tracking, type = "error_binned", nsamples = 1000)
# The models tends to overpredict high values and underpredict low values.
@
