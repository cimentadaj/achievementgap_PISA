...
{\centering \includegraphics[width=5.5in,height=5in]{figure/graph_complete_tracking_graph-1} 
...
{\centering \includegraphics[width=5.5in,height=5in]{figure/interaction_plot-1} 
